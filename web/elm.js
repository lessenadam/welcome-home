...
var _user$project$MessageForm$initialErrors = {userId: '', message: '', usernameTaken: false};
var _user$project$MessageForm$initialModel = {userId: '', message: '', errors: _user$project$MessageForm$initialErrors};
var _user$project$MessageForm$withUsernameTaken = F2(
...
var _user$project$MessageForm$getErrors = function (model) {
	return {
		userId: _elm_lang$core$Native_Utils.eq(model.userId, '') ? 'Please enter a user number!' : '',
		message: _elm_lang$core$Native_Utils.eq(model.message, '') ? 'Please enter a message!' : '',
		usernameTaken: model.errors.usernameTaken
	};
};
var _user$project$MessageForm$update = F2(
	function (msg, model) {
		if (_elm_lang$core$Native_Utils.eq(msg.msgType, 'VALIDATE')) {
			var successToMsg = function (result) {
				return {msgType: 'USERNAME_TAKEN', payload: ''};
			};
			var failureToMsg = function (err) {
			...
			return {
				...
				_0: _elm_lang$core$Native_Utils.update(
					model,
					{
						errors: _user$project$MessageForm$getErrors(model)
					}),
				_1: cmd
			};
		} else {
			if (_elm_lang$core$Native_Utils.eq(msg.msgType, 'USERNAME_TAKEN')) {
				return {
					ctor: '_Tuple2',
					_0: A2(_user$project$MessageForm$withUsernameTaken, true, model),
				...
				if (_elm_lang$core$Native_Utils.eq(msg.msgType, 'USERNAME_AVAILABLE')) {
					return {
						ctor: '_Tuple2',
						_0: A2(_user$project$MessageForm$withUsernameTaken, false, model),
						_1: _elm_lang$core$Platform_Cmd$none
					};
				} else {
...
var _user$project$MessageForm$viewUsernameErrors = function (model) {
	return model.errors.usernameTaken ? 'That username is taken!' : model.errors.userId;
};
var _user$project$MessageForm$view = function (model) {
	return A2(
		_elm_lang$html$Html$form,
		_elm_lang$core$Native_List.fromArray(
			[
				_elm_lang$html$Html_Attributes$id('message-form')
			]),
		_elm_lang$core$Native_List.fromArray(
			[
				A2(
				...
				_elm_lang$core$Native_List.fromArray(
					[
						_elm_lang$html$Html$text('Save a message for a given user')
					])),
				A2(
				_elm_lang$html$Html$label,
				_elm_lang$core$Native_List.fromArray(
					[
						_elm_lang$html$Html_Attributes$for('userId-field')
					]),
				_elm_lang$core$Native_List.fromArray(
					[
				...
				_elm_lang$core$Native_List.fromArray(
					[
						_elm_lang$html$Html_Attributes$id('userId-field'),
						_elm_lang$html$Html_Attributes$type$('text'),
						_elm_lang$html$Html_Attributes$value(model.userId),
				...
				_elm_lang$core$Native_List.fromArray(
					[
						_elm_lang$html$Html_Attributes$for('message')
					]),
				_elm_lang$core$Native_List.fromArray(
					[
				...
				_elm_lang$core$Native_List.fromArray(
					[
						_elm_lang$html$Html_Attributes$id('message'),
						_elm_lang$html$Html_Attributes$type$('text'),
				...
				_elm_lang$core$Native_List.fromArray(
					[
						_elm_lang$html$Html$text('Update message')
					]))
			]));
};
var _user$project$MessageForm$main = {
	main: _elm_lang$html$Html_App$program(
		{
			init: {ctor: '_Tuple2', _0: _user$project$MessageForm$initialModel, _1: _elm_lang$core$Platform_Cmd$none},
			view: _user$project$MessageForm$view,
			update: _user$project$MessageForm$update,
...
var Elm = {};
Elm['MessageForm'] = Elm['MessageForm'] || {};
_elm_lang$core$Native_Platform.addPublicModule(Elm['MessageForm'], 'MessageForm', typeof _user$project$MessageForm$main === 'undefined' ? null : _user$project$MessageForm$main);
